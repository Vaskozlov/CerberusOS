...
namespace ARCH{
    ...
    strict_inline static u8 rotate_left8 (u8 u, u8 r)
    {
        __asm__ ("rolb %%cl, %0" : "+r" (u) : "c" (r));
        return u;
    }

    strict_inline static u16 rotate_left16 (u16 u, u8 r)
    {
        __asm__ ("rolw %%cl, %0" : "+r" (u) : "c" ((u16)r));
        return u;
    }

    strict_inline static u32 rotate_left32(u32 u, u8 r)
    {
        __asm__ ("roll %%cl, %0" : "+r" (u) : "c" (r));
        return u;
    }

    strict_inline static u64 rotate_left64(u64 u, u8 r)
    {
        __asm__ ("rolq %%cl, %0" : "+r" (u) : "c" (r));
        return u;
    }

    strict_inline static void memset8(void *__address, u8 __value, size_t __times){
        ::memset8(__address, __value, __times);
    }

    strict_inline static void memset64(void *__address, u16 __value, size_t __times){
        ::memset16(__address, __value, __times);
    }

    strict_inline static void memset32(void *__address, u32 __value, size_t __times){
        ::memset32(__address, __value, __times);
    }

    strict_inline static void memset64(void *__address, u64 __value, size_t __times){
